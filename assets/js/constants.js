const PROJECTS = [
    ...
    },
    {
        ...
        image: '/assets/projects/uni1.png',
        liveLink: '',
    ...
    },
    {
        ...
        image: '/assets/projects/docker.png',
        liveLink: '',
    ...
    },
    {
        ...
        image: '/assets/projects/flask.avif',
        liveLink: '',
        githubLink: 'https://github.com/alexop89056/custom-form-validator'
    }
]

const SKILLS_ARRAY = ['Python', 'JavaScript', 'Go', 'Flask', 'Django', 'FastApi', 'Gunicorn', 'Ubuntu', 'Nginx', 'Celery', 'SQLAlchemy', 'PostgreSQL',
    'MySQL','SQL', 'RESTful API ', 'Design Patterns', 'Microservice Architecture','Docker', 'BashScript'];
